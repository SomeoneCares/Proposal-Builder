...
**Token:** `{{section_deliverables}}`  
**Group:** Cross-Cutting  
**Required:** No

---

The table below lists what {{customer_short}} receives at each stage of this engagement.

| Stage | Deliverables |
| :--- | :--- |
| Licenses | License keys or entitlements for the modules listed in the licenses coverage section. Delivery constitutes acceptance. <!-- if licenses --> |
...
Licensed software is deemed delivered, and thereby accepted, on delivery of the keys or entitlements. <!-- if licenses -->
Managed services are not subject to acceptance; performance is measured and reported against the Operations Level Agreement. <!-- if managed_services -->

*[Confirm the deliverable list per bid against the scope numbers in the professional services section.]*

## Documentation Format

Deliverables are issued in Verto Wave's standard document formats in English, unless another format or language is agreed in writing before the stage begins.
