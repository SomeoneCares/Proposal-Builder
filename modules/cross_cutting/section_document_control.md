...
**Token:** `{{section_document_control}}`  
**Group:** Cross-Cutting  
**Required:** Yes
...
| :--- | :--- | :--- | :--- |
| {{proposal_version}} | {{proposal_date_iso}} | {{author_name}} | Initial issue |
| | | | |
...
Where a module references platform screenshots to illustrate the underlying technology:

- Equivalent platform reference screenshots may be included to illustrate the underlying technology.
- In the StackX service, equivalent screens would be presented under the StackX brand and configured with the customer's entities, categories, workflows, assets and service catalog.
- Any screenshots are included transparently and are not represented as screenshots of a separately developed product.
- Do not include third-party product screenshots, vendor product diagrams, or images that imply a separately developed or rebranded product.
...
*This section is a reusable building block. Populate the cover metadata and change-history table per bid. Never issue a proposal with placeholder metadata unresolved.*